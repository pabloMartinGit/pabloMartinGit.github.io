jQuery("#simulation")
  .on("click", ".s-2b4d8da0-50e2-4551-9790-7a05236ee670 .click", function(event, data) {
  ...
  .on("pageload", ".s-2b4d8da0-50e2-4551-9790-7a05236ee670 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseenter dragenter", ".s-2b4d8da0-50e2-4551-9790-7a05236ee670 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-2b4d8da0-50e2-4551-9790-7a05236ee670 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
