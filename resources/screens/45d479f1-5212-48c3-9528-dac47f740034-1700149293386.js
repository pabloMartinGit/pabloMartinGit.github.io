jQuery("#simulation")
  .on("click", ".s-45d479f1-5212-48c3-9528-dac47f740034 .click", function(event, data) {
            ...
            },
            {
              "actions": [
                ...
                },
                {
                  "action": "jimPlayAudio",
                  "parameter": {
                    "target": [ "4eb44f77-5d76-4a75-9c1e-64535f3538aa.mp3" ]
                  },
                  "exectype": "parallel",
                  "delay": 0
                },
              ...
              "actions": [
                {
                  "action": "jimPlayAudio",
                  "parameter": {
                    "target": [ "875b21df-84df-4428-b72b-65a10ef5680f.mp3" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                },
          ...
          "blocks": [
            {
              ...
              "actions": [
                ...
                },
                {
                  ...
                  "parameter": {
                    "target": "screens/e045d30c-2c10-49df-a627-0d18118a798d",
                    "transition": {
                      "type": "fade",
                      "duration": 700
                    }
  ...
  .on("pageload", ".s-45d479f1-5212-48c3-9528-dac47f740034 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Paragraph_40")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  "action": "jimHide",
                  "parameter": {
                    "target": [ "#s-Path_1","#s-Paragraph_1","#s-Rectangle_28" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("mouseenter dragenter", ".s-45d479f1-5212-48c3-9528-dac47f740034 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
    if(jFirer.is("#s-Paragraph_61") && jFirer.has(event.relatedTarget).length === 0) {
              ...
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-Rectangle_28","#s-Paragraph_1","#s-Path_1" ],
                    "effect": {
                      "type": "blind",
                      "easing": "linear",
                      "duration": 500
  ...
  .on("mouseleave dragleave", ".s-45d479f1-5212-48c3-9528-dac47f740034 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
    if(jFirer.is("#s-Paragraph_61")) {
