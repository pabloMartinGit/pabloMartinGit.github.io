jQuery("#simulation")
  .on("click", ".s-7bbec92c-f779-4bc2-9d85-ba237c06d714 .click", function(event, data) {
  ...
  .on("pageload", ".s-7bbec92c-f779-4bc2-9d85-ba237c06d714 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseenter dragenter", ".s-7bbec92c-f779-4bc2-9d85-ba237c06d714 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-7bbec92c-f779-4bc2-9d85-ba237c06d714 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
