jQuery("#simulation")
  .on("click", ".s-ef2533d2-0f1e-4d0b-b7b3-a7fa22341f0b .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimPlayAudio",
                  "parameter": {
                    "target": [ "4fd48070-c917-433c-85e4-cf11c6865ccc.mp3" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimPlayAudio",
                  "parameter": {
                    "target": [ "824ab07b-27f2-491e-9fbd-ba46cf2d2b43.mp3" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimPlayAudio",
                  "parameter": {
                    "target": [ "b0ccea0a-80ec-4a10-9894-5b98cf995dab.mp3" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimPlayAudio",
                  "parameter": {
                    "target": [ "1151bd0f-d6d6-4014-827d-0cb6e242296d.mp3" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("pageload", ".s-ef2533d2-0f1e-4d0b-b7b3-a7fa22341f0b .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  "action": "jimHide",
                  "parameter": {
                    "target": [ "#s-Path_4","#s-Paragraph_20","#s-Rectangle_9" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("mouseenter dragenter", ".s-ef2533d2-0f1e-4d0b-b7b3-a7fa22341f0b .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-ef2533d2-0f1e-4d0b-b7b3-a7fa22341f0b .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
