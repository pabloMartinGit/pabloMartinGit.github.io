jQuery("#simulation")
  .on("click", ".s-51f83883-39f8-40ea-a653-8d4db39fb56c .click", function(event, data) {
  ...
  .on("pageload", ".s-51f83883-39f8-40ea-a653-8d4db39fb56c .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseenter dragenter", ".s-51f83883-39f8-40ea-a653-8d4db39fb56c .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseleave dragleave", ".s-51f83883-39f8-40ea-a653-8d4db39fb56c .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
