jQuery("#simulation")
  .on("click", ".s-b774e602-0949-4049-8750-610650ce44f5 .click", function(event, data) {
  ...
  .on("pageload", ".s-b774e602-0949-4049-8750-610650ce44f5 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
